...
class Story(db.Model):
    ...
    comments = db.relationship('Comments', backref='story', lazy=True, cascade='all, delete-orphan')
    ...
    bookmark = db.relationship('Bookmark', backref='story', lazy=True, cascade='all, delete-orphan')
